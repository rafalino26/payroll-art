  ...
  return (
    <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-2xl shadow-lg border border-gray-200">
      ...
      <form action={handleFormAction} className="space-y-6">
        ...
        <SubmitButton className="w-full py-3 px-4 border border-transparent rounded-lg shadow-sm text-base font-medium text-white bg-[#e799ff] hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#e799ff] transition-opacity">
          Buat & Mulai
        </SubmitButton>
      </form>
    </div>
